...
namespace Week4LabProgramQuestion
{
    class Shapes
    {
        ...
        private const double PI = Math.PI;// Define the value of pi
        ...
        public void Display(char shapeType)
        {
            ...
            if (shapeType == 'r')
                Console.WriteLine("Height and Width of rectangle is: {0}, {1}", this.height, this.width);
            else if (shapeType == 'c')
...
The program should produce the following result
  ...
  Note the result
  Area of Circle becomes: 314.159
  Area of Rectangle  becomes: 75
 */
